...
# ================= KONFIGURASI =================
# Ganti ini dengan Token Bot Telegram lu!
...
def webhook():
    try:
        ...
        if 'document' in message:
            ...
            send_message(chat_id, f"✅ Ditemukan {len(accounts)} akun. Mengirim {len(accounts)} file `guest100067.dat`...")

            # 🔥 PERBAIKAN FINAL: KIRIM SATU PERSATU, BUKAN ZIP!
            for acc in accounts:
